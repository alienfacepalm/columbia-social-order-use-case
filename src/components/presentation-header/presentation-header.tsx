    ...
    <div className="flex shrink-0 flex-col items-center sm:flex-row sm:items-center sm:justify-between w-full gap-2 py-2 pt-3 sm:py-3 sm:pt-4">
      ...
      <div className="flex flex-col items-center gap-1.5 sm:items-end sm:gap-1 text-center sm:text-right">
        ...
        >
          ...
          />
          <span
            className={`relative z-10 flex flex-1 items-center justify-center text-[0.65rem] sm:text-xs font-medium transition-colors ${
              !isSimple ? 'text-[#1d3356] font-semibold' : 'text-white/70'
            }`}
          >
            Advanced
          </span>
